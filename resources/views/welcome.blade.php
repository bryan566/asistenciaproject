 ...
 <link rel="stylesheet" href="css/responsive.css">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav mr-auto w-100 justify-content-end">
                ...
                <li class="nav-item">
                    <a class="btn btn-warning underline" href="{{route('register')}}">REGISTRO</a>
                </li>-->
   ...
   <div class="col-lg-6 col-md-12 col-xs-12">
          ...
          <!--<div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ route('login') }}" class="text-sm btn btn-warning text-gray-700 dark:text-gray-500 underline">Log in</a>

            <a href="{{ route('register') }}" class="ml-4 btn btn-primary text-sm text-gray-700 dark:text-gray-500 underline">Register</a>
</div>-->
        ...
        <div class="container">      
          <div class="row space-100">
            <div class="col-lg-6 col-md-12 col-xs-12">
              <div class="contents">
                <h2 class="head-title">Control de Asistencia del Personal</h2>
